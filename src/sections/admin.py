...
class AdminSection(Section):
    ...
    def send_message_to_auditory(
        ...
        if auditory == "all":
            users = [user]#User.objects.filter(additional_info__ne=None)

        elif auditory == "me":
            users = [user]

        elif auditory == "unregistered":
            users = [user]#User.objects.filter(additional_info=None)

        elif auditory == "no_cv":
            users = [user]#User.objects.filter(cv_file_id=None, additional_info__ne=None)
